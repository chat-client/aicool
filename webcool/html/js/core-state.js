...
function selectRenameInputText(input) {
      ...
      var api = {
        ...
        imageEnhance: '/api/v1/image/enhance',
        imageEnhanceProgress: '/api/v1/image/enhance/progress',
        imageEnhanceCancel: '/api/v1/image/enhance/cancel',
        ...
        localDiskImageEnhance: '/api/v1/local-disk/image/enhance',
        localDiskImageEnhanceProgress: '/api/v1/local-disk/image/enhance/progress',
        localDiskImageEnhanceCancel: '/api/v1/local-disk/image/enhance/cancel',
        ...
        videoSubtitleExport: '/api/v1/video/subtitle/export',
        localDiskVideoSubtitleExport: '/api/v1/local-disk/video/subtitle/export',
        videoSubtitleExportProgress: '/api/v1/video/subtitle/export/progress',
        videoSubtitleExportCancel: '/api/v1/video/subtitle/export/cancel',
        localDiskVideoSubtitleExportProgress: '/api/v1/local-disk/video/subtitle/export/progress',
        localDiskVideoSubtitleExportCancel: '/api/v1/local-disk/video/subtitle/export/cancel',
        videoKeyframeExport: '/api/v1/video/keyframes/export',
        videoKeyframeExportProgress: '/api/v1/video/keyframes/export/progress',
        videoKeyframeExportCancel: '/api/v1/video/keyframes/export/cancel',
        localDiskVideoKeyframeExport: '/api/v1/local-disk/video/keyframes/export',
        localDiskVideoKeyframeExportProgress: '/api/v1/local-disk/video/keyframes/export/progress',
        localDiskVideoKeyframeExportCancel: '/api/v1/local-disk/video/keyframes/export/cancel',
