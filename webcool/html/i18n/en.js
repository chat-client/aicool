(function () {
  var textMap = {
    ...
    ,'HEIC图片预览组件加载失败：': 'Failed to load HEIC image preview runtime: '
    ...
    ,'正在读取媒体属性...': 'Reading media properties...'
    ,'文件名': 'File name'
    ,'文件大小': 'File size'
    ,'时长': 'Duration'
    ,'总码率': 'Overall bitrate'
    ...
    ,'帧率': 'Frame rate'
    ,'视频码率': 'Video bitrate'
    ,'自动建议：': 'Auto recommendation: '
    ,'（已保留手工设置）': ' (manual setting kept)'
    ,'（随分辨率自动调整）': ' (adjusts with resolution)'
    ,'点击恢复自动码率': 'Click to restore automatic bitrate'
    ,'音频编码': 'Audio codec'
    ,'无音轨': 'No audio track'
    ,'采样率': 'Sample rate'
    ,'声道': 'Channels'
    ,'音频码率': 'Audio bitrate'
    ,'提升码率和分辨率': 'Enhance bitrate and resolution'
    ,'建议值可根据需要手工修改。普通转码无法恢复源视频已经丢失的真实细节。': 'You can edit the suggested values. Regular transcoding cannot restore detail already lost from the source video.'
    ,'目标宽度': 'Target width'
    ,'目标高度': 'Target height'
    ,'开始提升': 'Start enhancement'
    ,'生成10秒三方案对比': 'Generate 10-second 3-way comparison'
    ,'正在依次生成极速和高质量10秒对比文件': 'Generating fastest and quality 10-second comparison files in sequence'
    ,'三方案对比已生成：原视频、': 'Three-way comparison generated: original, '
    ,'对比文件生成失败：': 'Comparison generation failed: '
    ,'正在提升画质': 'Enhancing video quality'
    ,'无法启动画质提升': 'Unable to start video enhancement'
    ,'画质提升失败': 'Video enhancement failed'
    ,'画质提升失败：': 'Video enhancement failed: '
    ,'画质提升完成：': 'Video enhancement completed: '
    ,'请输入有效的偶数宽高和视频码率': 'Enter valid even-numbered dimensions and video bitrate'
    ,'降噪强度': 'Denoise strength'
    ,'轻度': 'Light'
    ,'中度': 'Medium'
    ,'锐化强度': 'Sharpening strength'
    ,'去隔行（仅老式隔行视频建议开启）': 'Deinterlace (recommended only for old interlaced video)'
    ,'运动补帧': 'Motion interpolation'
    ,'保持原帧率': 'Keep original frame rate'
    ,'补帧可以改善运动流畅度，但会显著增加处理时间。': 'Frame interpolation can improve motion smoothness but significantly increases processing time.'
    ,'处理方式': 'Processing method'
    ,'普通增强（快速）': 'Standard enhancement (fast)'
    ,'AI超分辨率（高质量，耗时）': 'AI super-resolution (high quality, slow)'
    ,'AI超分辨率': 'AI super-resolution'
    ,'AI模型': 'AI model'
    ,'旧视频修复预设': 'Old video restoration preset'
    ,'关闭预处理': 'Disable preprocessing'
    ,'保守（轻微处理）': 'Conservative (light)'
    ,'均衡（推荐）': 'Balanced (recommended)'
    ,'强化（严重压缩）': 'Strong (heavy compression)'
    ,'先去除压缩块和噪声，再进行AI超分，通常比直接放大更清晰。': 'Remove compression blocks and noise before AI upscaling for a generally clearer result.'
    ,'旧视频修复细化选项': 'Old video restoration details'
    ,'去压缩块': 'Deblocking'
    ,'AI前降噪': 'Denoise before AI'
    ,'轻微去模糊/预锐化': 'Mild deblur / pre-sharpen'
    ,'AI前去隔行（仅隔行视频开启）': 'Deinterlace before AI (interlaced video only)'
    ,'通用/真人': 'General / live action'
    ,'真实2×（高质量/较快）': 'True 2x (high quality / faster)'
    ,'轻量x4（速度优先）': 'Lightweight x4 (speed first)'
    ,'轻量W8A8 x4（M4实验）': 'Lightweight W8A8 x4 (M4 experimental)'
    ,'轻量模型的8位权重与8位激活版本，使用视频样本校准，针对M4 ANE。': 'Lightweight model with 8-bit weights and activations, video-calibrated for the M4 ANE.'
    ,'M4量化x4（质量优先）': 'M4 quantized x4 (quality first)'
    ,'原始x4（对照/最慢）': 'Original x4 (baseline / slowest)'
    ,'该模型使用固定推理倍数，最终仍会缩放到目标分辨率': 'This model uses a fixed inference scale; the result is still resized to the target resolution'
    ,'官方RealESRGAN_x2plus，保留真人细节，适合约2×放大。': 'Official RealESRGAN_x2plus; preserves live-action detail and suits approximately 2x enlargement.'
    ,'官方tiny通用模型，速度最快，适合先比较速度和可接受画质。': 'Official tiny general model; fastest for comparing speed against acceptable quality.'
    ,'高质量x4网络的8位权重量化版，用于比较M4速度、体积和画质。': '8-bit weight-quantized high-quality x4 network for comparing M4 speed, size, and quality.'
    ,'原始高质量x4模型，模型最大且最慢，作为画质基准。': 'Original high-quality x4 model; largest and slowest, used as the quality baseline.'
    ,'动漫视频专用模型，不建议用于真人视频。': 'Anime-specific model; not recommended for live-action video.'
    ,'动漫': 'Anime'
    ...
    ,'均衡': 'Balanced'
    ,'高质量': 'High quality'
    ,'高级性能选项': 'Advanced performance options'
    ,'自动': 'Automatic'
    ,'显存不足时选择较小值；较大值通常更快。': 'Choose a smaller value when VRAM is insufficient; larger values are usually faster.'
    ,'推理线程': 'Inference threads'
    ,'GPU编号': 'GPU index'
    ,'计算单元': 'Compute units'
    ,'推理输入尺寸': 'Inference input size'
    ,'极速（允许大幅预缩小）': 'Fastest (allows substantial pre-downscaling)'
    ,'均衡（最多缩小25%）': 'Balanced (at most 25% downscaling)'
    ,'画质（不缩小源画面）': 'Quality (never downscale source)'
    ,'画质模式保留全部源像素但耗时更长；极速模式可能损失原始细节。': 'Quality keeps every source pixel but takes longer; fastest mode may lose original detail.'
    ,'目标感知（推荐/更快）': 'Target-aware (recommended / faster)'
    ,'保持源分辨率（最慢）': 'Keep source resolution (slowest)'
    ,'目标感知会避免先过度放大再缩小，显著减少Tile数量。': 'Target-aware sizing avoids excessive upscaling followed by downscaling and greatly reduces tile count.'
    ,'自动（CPU/GPU/ANE）': 'Automatic (CPU/GPU/ANE)'
    ,'GPU优先': 'Prefer GPU'
    ,'Neural Engine优先': 'Prefer Neural Engine'
    ,'Core ML并发': 'Core ML concurrency'
    ,'按模型自动': 'Automatic by model'
    ,'重模型通常1个更快，轻量模型通常2个更快。': 'One worker is usually faster for heavy models; two for lightweight models.'
    ,'Tile批量': 'Tile batch size'
    ,'批量可提高ANE吞吐，但会增加统一内存占用。': 'Batching may improve ANE throughput but uses more unified memory.'
    ,'Tile重叠': 'Tile overlap'
    ,'较少（更快）': 'Low (faster)'
    ,'较多（减少接缝）': 'High (fewer seams)'
    ,'时序复用': 'Temporal reuse'
    ,'每帧推理（最佳画质）': 'Infer every frame (best quality)'
    ,'自适应静态帧（推荐）': 'Adaptive static frames (recommended)'
    ,'自适应模式仅复用静态或近似静态画面，并定期强制刷新。': 'Adaptive mode only reuses static or near-static frames and forces periodic refreshes.'
    ,'每2帧推理（较快）': 'Infer every 2 frames (faster)'
    ,'每3帧推理（最快）': 'Infer every 3 frames (fastest)'
    ,'复用上一增强帧会提速，但快速运动可能出现轻微顿挫。': 'Reusing the previous enhanced frame is faster, but fast motion may look slightly choppy.'
    ,'仅CPU（对照）': 'CPU only (baseline)'
    ,'仅Core ML模型有效；建议用相同短片段分别测试耗时。': 'Core ML models only; compare each option with the same short segment.'
    ,'动漫模型使用NCNN后端，计算单元选项不适用': 'The anime model uses the NCNN backend; compute-unit selection does not apply.'
    ,'最终编码速度': 'Final encoding speed'
    ,'试跑范围': 'Test range'
    ,'完整视频': 'Full video'
    ,'仅前10秒': 'First 10 seconds only'
    ,'仅前30秒': 'First 30 seconds only'
    ,'仅前60秒': 'First 60 seconds only'
    ,'建议先试跑短片段，确认模型和参数效果。': 'Test a short segment first to verify the model and settings.'
    ,'可先转换短片段，确认参数和画面效果。': 'Convert a short segment first to verify the settings and visual result.'
    ,'预计剩余约': 'Estimated remaining: about '
    ,'已耗时': 'Elapsed: '
    ,'总耗时': 'Total time: '
    ,'小时': ' h '
    ,'秒': ' sec'
    ,'分钟': ' min'
    ,'通用模型仅支持4×推理，最终仍会缩放到目标分辨率': 'The general model only supports 4× inference; the result is still resized to the target resolution.'
    ,'正在启动音频提取：': 'Starting audio extraction: '
    ,'无法启动音频提取': 'Unable to start audio extraction'
    ,'正在提取音频：': 'Extracting audio: '
    ,'音频提取失败：': 'Audio extraction failed: '
    ,'音频提取完成：': 'Audio extraction completed: '
    ...
    ,'保持原始': 'Keep original'
    ,'将导出为新的 MP4 文件，原视频不会被修改。': 'A new MP4 will be created; the original video will not be changed.'
    ...
    ,'导出失败': 'Export failed'
    ,'导出失败：': 'Export failed: '
    ,'无法启动视频剪辑': 'Unable to start video editing'
    ,'视频剪辑完成：': 'Video edit complete: '
    ,'完成': 'Done'
    ,'音轨': 'Audio Track'
    ,'音频处理': 'Audio handling'
    ,'保留原音频': 'Keep original audio'
    ,'去除音频': 'Remove audio'
    ,'添加或替换音频': 'Add or replace audio'
    ,'音频文件': 'Audio file'
    ,'选择当前磁盘中的音频文件': 'Choose an audio file on the current disk'
    ,'起始位置': 'Start position'
    ,'导出原音频': 'Export original audio'
    ,'字幕轨': 'Subtitle Track'
    ,'字幕处理': 'Subtitle handling'
    ,'保留原字幕': 'Keep original subtitles'
    ,'去除字幕': 'Remove subtitles'
    ,'添加或替换字幕': 'Add or replace subtitles'
    ,'字幕文件': 'Subtitle file'
    ,'选择当前磁盘中的字幕文件': 'Choose a subtitle file on the current disk'
    ,'选择字幕文件位置': 'Choose a subtitle file'
    ,'导出原字幕': 'Export original subtitles'
    ,'开始添加字幕': 'Start adding subtitles'
    ,'添加方式': 'Add method'
    ,'快速封装（不重新编码）': 'Fast remux (no re-encoding)'
    ,'兼容转码（应用全部编辑）': 'Compatible transcode (apply all edits)'
    ,'快速封装速度快，但不能同时应用画面、变速或音频编辑；裁剪点可能对齐到关键帧。': 'Fast remux is much quicker, but cannot apply video, speed, or audio edits; trim points may align to keyframes.'
    ,'兼容转码会重新编码视频，可应用剪辑窗口中的全部设置。': 'Compatible transcode re-encodes the video and applies all editor settings.'
    ,'快速封装不能同时应用画面、变速或音频编辑，请选择兼容转码': 'Fast remux cannot apply video, speed, or audio edits; choose compatible transcode.'
    ,'正在开始添加字幕': 'Starting subtitle addition'
    ,'正在上传字幕文件': 'Uploading subtitle file'
    ,'字幕文件上传失败': 'Subtitle file upload failed'
    ,'请选择 SRT、VTT、ASS 或 SSA 字幕文件': 'Choose an SRT, VTT, ASS, or SSA subtitle file'
    ,'请选择音频文件': 'Choose an audio file'
    ,'请选择字幕文件': 'Choose a subtitle file'
    ,'导出音频失败：': 'Audio export failed: '
    ,'导出字幕失败：': 'Subtitle export failed: '
    ,'字幕导出完成：': 'Subtitle export complete: '
    ,'音频导出完成：': 'Audio export complete: '
    ,'正在启动音频导出': 'Starting audio export'
    ,'正在启动字幕导出': 'Starting subtitle export'
    ,'正在导出音频': 'Exporting audio'
    ,'正在导出字幕': 'Exporting subtitles'
    ,'已用时': 'Elapsed'
    ,'连续截取关键帧': 'Export Keyframes'
    ,'将所选时段内的关键帧导出到与视频同名的目录。': 'Export keyframes from the selected range to a folder named after the video.'
    ,'正在启动关键帧截屏': 'Starting keyframe export'
    ,'正在导出关键帧': 'Exporting keyframes'
    ,'正在截取关键帧': 'Capturing keyframes'
    ,'正在整理截屏图片': 'Organizing screenshots'
    ,'关键帧截屏完成：': 'Keyframe export complete: '
    ,'导出关键帧失败：': 'Keyframe export failed: '
    ,'截屏': 'Screenshot'
    ,'正在启动截屏': 'Starting screenshot capture'
    ,'正在截取当前画面': 'Capturing current frame'
    ...
    ,'提升图片清晰度': 'Enhance image clarity'
    ,'编辑': 'Edit'
    ,'图片编辑': 'Edit Image'
    ,'当前路径': 'Current path'
    ,'转到': 'Go'
    ,'跳转本地路径失败：': 'Failed to open local path: '
    ,'亮度调整': 'Brightness adjustment'
    ,'亮度设置': 'Brightness Settings'
    ,'亮度': 'Brightness'
    ,'正值提亮照片，负值压暗照片；建议先从20%开始。': 'Positive values brighten the photo and negative values darken it. Start around 20%.'
    ,'正在启动亮度调整': 'Starting brightness adjustment'
    ,'CodeFormer人脸重建': 'CodeFormer Face Reconstruction'
    ,'单一窗口': 'Single window'
    ,'层叠窗口': 'Cascading windows'
    ,'多标签窗口': 'Tabbed window'
    ,'图片预览标签': 'Image preview tabs'
    ,'CodeFormer人脸重建设置': 'CodeFormer Face Reconstruction Settings'
    ,'CodeFormer修复模式': 'CodeFormer restoration mode'
    ,'修复模式': 'Restoration mode'
    ,'遮挡或残缺人脸重建': 'Occluded or incomplete face reconstruction'
    ,'白色遮挡人脸重建': 'White-mask face reconstruction'
    ,'普通照片人脸修复': 'Normal photo face restoration'
    ,'修复后继续AI超分': 'Apply AI upscaling after restoration'
    ,'直接将整张图片作为对齐人脸重建，输出CodeFormer原生512×512结果。': 'Treat the whole image as an aligned face and produce CodeFormer’s native 512×512 result.'
    ,'使用CodeFormer专用遮挡修复模型，将纯白遮挡区域重建为512×512人脸。': 'Use CodeFormer’s dedicated inpainting model to reconstruct pure-white masked regions as a 512×512 face.'
    ,'先检测照片中的人脸，修复后回贴到原图，保持原图尺寸。': 'Detect faces first, restore and paste them back while preserving the source dimensions.'
    ,'遮挡区域没有真实信息，模型重建结果可能与原人物不同。': 'Occluded regions contain no source information, so the reconstructed face may differ from the real person.'
    ,'正在启动CodeFormer人脸重建': 'Starting CodeFormer face reconstruction'
    ,'去红眼': 'Remove red-eye'
    ,'自动去红眼': 'Automatic red-eye removal'
    ,'自动检测并校正照片红眼': 'Automatically detect and correct red-eye in photos'
    ,'去红眼设置': 'Red-eye Removal Settings'
    ,'校正强度': 'Correction strength'
    ,'仅处理主体人脸': 'Process only the main face'
    ,'仅在检测到的瞳孔区域内校正红色像素，不会生成或重绘五官。': 'Corrects red pixels only inside detected pupil regions; facial features are not generated or redrawn.'
    ,'正在启动自动去红眼': 'Starting automatic red-eye removal'
    ,'去水印': 'Remove watermark'
    ,'框选水印区域并去除': 'Select a watermark area and remove it'
    ,'在图片上拖拽框选水印区域，然后点击“应用”。': 'Drag over the watermark, then click Apply.'
    ,'在图片上拖拽选择剪切区域，然后点击“应用”。': 'Drag to select a crop area, then click Apply.'
    ,'请先在图片上拖拽框选水印区域。': 'Drag over the watermark area first.'
    ,'水印框选区域太小，请重新框选。': 'The selected watermark area is too small. Please select it again.'
    ,'图片尺寸太小，无法去水印。': 'The image is too small for watermark removal.'
    ,'正在启动去水印处理…': 'Starting watermark removal…'
    ,'正在去水印': 'Removing watermark'
    ,'图片去水印失败': 'Watermark removal failed'
    ,'图片去水印失败：': 'Watermark removal failed: '
    ,'去水印完成，已生成新图片：': 'Watermark removed. New image: '
    ,'去模糊后AI超分': 'Deblur then AI upscale'
    ,'去模糊类型': 'Deblur type'
    ,'去模糊强度（保留原貌）': 'Deblur strength (preserve identity)'
    ,'人脸修复': 'Face restoration'
    ,'人脸保真度（越高越接近原貌）': 'Face fidelity (higher preserves identity)'
    ,'仅修复主体人脸（防止局部误识别）': 'Restore only the main face (prevents false local detections)'
    ,'CodeFormer使用官方独立运行环境；未安装时选择该选项会给出配置提示。': 'CodeFormer uses its official separate runtime; if it is not installed, configuration guidance will be shown.'
    ,'运动模糊': 'Motion blur'
    ,'失焦模糊': 'Defocus blur'
    ,'正在启动去模糊并超分': 'Starting deblur and AI upscale'
    ,'转换会生成新图片，不会覆盖原图。': 'Conversion creates a new image and does not overwrite the original.'
    ,'锐化': 'Sharpen'
    ,'转换': 'Convert'
    ,'正在启动AI超分辨率': 'Starting AI super-resolution'
    ,'正在启动图片锐化': 'Starting image sharpening'
    ,'无法启动图片转换': 'Unable to start image conversion'
    ,'正在转换图片': 'Converting image'
    ,'图片转换失败': 'Image conversion failed'
    ,'图片转换失败：': 'Image conversion failed: '
    ,'图片转换完成：': 'Image conversion complete: '
    ,'AI图片超分详细设置': 'AI Image Super-resolution Settings'
    ,'详细设置': 'Details'
    ,'AI截图详细设置': 'AI Screenshot Settings'
    ,'图片质量': 'Image quality'
    ,'保存设置': 'Save Settings'
    ,'正在启动AI增强截屏': 'Starting AI-enhanced screenshot'
    ,'AI正在增强当前画面': 'AI is enhancing the current frame'
    ,'AI截屏完成：': 'AI screenshot complete: '
    ,'AI截屏失败：': 'AI screenshot failed: '
    ,'正在锐化并截取当前画面': 'Sharpening and capturing the current frame'
    ,'正在保存截屏图片': 'Saving screenshot'
    ,'正在准备AI截屏画面': 'Preparing the frame for AI enhancement'
    ,'准备AI推理': 'Preparing AI inference'
    ,'AI正在恢复纹理与细节': 'AI is restoring texture and detail'
    ,'AI超分辨率完成': 'AI super-resolution complete'
    ,'读取中…': 'Loading…'
