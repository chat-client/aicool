...
using check_perm_t = std::function<bool(const char*, request_t&, response_t&, bool&)>;
using after_handle_t = std::function<void(const char*, request_t&)>;
...
public:
	...
	http_service& CheckPerm(check_perm_t fn);
...
private:
	...
	http_default_handler_t  handler_default_ = nullptr;
	check_perm_t check_perm_ = nullptr;
	after_handle_t after_handle_ = nullptr;
